...
class UsersController {
  ...
  public getUsers = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const findAllUsersData: Omit<User, 'password'>[] = await this.userService.findAllUser();
  ...
  public getUserById = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const findOneUserData: Omit<User, 'password'> = await this.userService.findUserById(userId);
  ...
  public createUser = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const createUserData: Omit<User, 'password'> = await this.userService.createUser(userData);
  ...
  public updateUser = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const userId = Number(req.params.id);
      const userData: CreateUserDto = req.body;
      const updateUserData: Omit<User, 'password'> = await this.userService.updateUser(userId, userData);
